...
{   Image               img, back_img, img_bullet,teki,lose,gameclear,gameover;
    ...
    {   if (back==null || pos_back<0)    return;
        ...
        if(score>=1000){
            g.drawImage(gameclear,0,0,this);
        }
        if((deadflag == 1) && (score<1000)){
            g.drawImage(gameover,0,0,this);
        }
        g.drawImage(g_board[0],SCORE_X,25,this);

        score2 = score;
        num2 = score2/100;      //num2 = 100の位
        num1 = (score2%100)/10;     //num1 = 10の位
        num0 = (score2%100)%10;     //num0 = 1の位

        
        g.drawImage(g_number[num2], SCORE_X+20+1*19, 50, this);
        g.drawImage(g_number[num1], SCORE_X+20+2*19, 50, this);
        g.drawImage(g_number[num0], SCORE_X+20+3*19, 50, this);
        /*if(score>=1000){
            g.drawImage(gameclear,135,250,this);
        }*/
    ...
    {   long wk= (System.currentTimeMillis()/30)%640;
        ...
        for(int i=0; i<list.size(); i++){
            ...
            }else if(CircleCollision(pos.x,I00,pos.y,I01)){
                deadflag = 1;
            }
        }
